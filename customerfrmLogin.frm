...
Begin VB.Form CustomerfrmLogin 
   BackColor       =   &H00FFFFFF&
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Customer Login Area"
   ClientHeight    =   2132
   ClientLeft      =   2834
   ClientTop       =   3484
   ClientWidth     =   4004
   Icon            =   "customerfrmLogin.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin MSAdodcLib.Adodc customerloginado 
      Height          =   299
      Left            =   1404
      Top             =   1872
      Visible         =   0   'False
      ...
      _Version        =   393216
   End
   Begin VB.TextBox customertxtUserName 
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.83
         Charset         =   0
   ...
   Begin VB.CommandButton cmdCancel 
      ...
      Width           =   1140
   End
   Begin VB.TextBox customertxtPassword 
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.83
         Charset         =   0
   ...
   Begin VB.Image Image1 
      Height          =   1066
      Left            =   117
      Picture         =   "customerfrmLogin.frx":1084A
      Stretch         =   -1  'True
      Top             =   1053
      Width           =   949
   End
   ...
   End
End
Attribute VB_Name = "CustomerfrmLogin"
...
Private Sub cmdOK_Click()
    customerloginado.RecordSource = "select * from CUSTOMER_DETAILS where USERNAME='" + customertxtUserName.Text + "' and PASSWORD='" + customertxtPassword.Text + "'"
    customerloginado.Refresh
    LoginSucceeded = True
    LoginUsername = customerloginado.Username
    
  
    
    If customerloginado.Recordset.EOF Then
    MsgBox "Invalid Details, try again!", vbCritical, "Oops! Wrong Detail"
    customertxtUserName.SetFocus
    SendKeys "{Home}+{End}"
    Else
